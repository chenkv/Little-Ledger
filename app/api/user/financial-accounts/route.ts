...
export async function POST(req: Request) {
  try {
    ...
    for (const account of accounts) {
      ...
      const description = typeof account.description === "string" ? account.description.trim() : "";
      ...
      const result = insertStmt.run(userId, name, type, institution, description);
      inserted.push({ id: result.lastInsertRowid, name, type, institution, description });
    }
